...
<div class="row tiles">
	...
	{{with .event}}<div class="col-xs-7">
		...
		<div style="height: 30px; margin-bottom: 10px">
			...
			<div style="display: inline-block; float: right; line-height: 1"><a id="event-mail" title="Empfehle die Veranstaltung per E-Mail." class="highlight" href="#" data-toggle="modal" data-target="#share"><span class="fa fa-envelope"></span> E-Mail</a></div>
		</div>
