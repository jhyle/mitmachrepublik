...
<div class="row tiles">
	...
	{{with .event}}<div class="col-xs-7">
		...
		<div style="height: 30px; margin-bottom: 10px">
			...
			<div style="display: inline-block; float: right; line-height: 1"><a id="event-mail" class="highlight" href="#" data-toggle="modal" data-target="#share"><span class="fa fa-envelope">&nbsp;E-Mail</span></a></div>
		</div>
