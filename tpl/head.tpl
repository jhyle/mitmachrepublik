	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 col-head">
				...
				| <a id="head-login" href="javascript:void(0)" data-href="/dialog/login" rel="nofollow" data-toggle="modal" data-target="#login" title="Melde Dich an, um Deine Veranstaltungen einzutragen.">Anmelden</a>
